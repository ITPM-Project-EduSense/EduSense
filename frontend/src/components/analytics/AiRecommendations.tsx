...
export default function AiRecommendations() {
    return (
        ...
        >
            {/* Ambient blob */}
            <div className="pointer-events-none absolute -left-16 -top-16 h-48 w-48 rounded-full bg-indigo-200/30 blur-3xl" />
                ...
                <div className="space-y-2.5">
                    {aiRecommendations.map((rec, i) => (
                        <motion.div
                            ...
                            className="group flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50/60 p-3.5 transition-all duration-200 hover:border-blue-300 hover:bg-blue-100/60"
                        >
                            {/* Priority dot */}
