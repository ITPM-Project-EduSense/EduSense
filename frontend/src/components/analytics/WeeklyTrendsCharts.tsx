...
function MiniLineChart({ data, color, gradId, label }: {
    ...
    return (
        <div>
            <p className="mb-2 text-xs font-semibold text-blue-300/75">{label}</p>
    ...
    return (
        <div>
            <div className="mb-2 flex items-center gap-4">
                <p className="text-xs font-semibold text-blue-300/75">{title}</p>
...
export default function WeeklyTrendsCharts() {
    return (
        ...
        >
            {/* Ambient blob */}
            <div className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-blue-500/8 blur-3xl" />

            <div className="relative">
                <div className="mb-5 flex items-center gap-3">
                    <div className="rounded-xl bg-blue-500/15 p-2 ring-1 ring-blue-500/25">
                        <TrendingUp size={16} className="text-blue-400" />
                    </div>
                    <div>
                        <h3 className="text-base font-semibold text-white">Weekly Performance Trends</h3>
                        <p className="text-[11px] text-blue-300/70">Last 7 days overview</p>
                    </div>
                </div>
