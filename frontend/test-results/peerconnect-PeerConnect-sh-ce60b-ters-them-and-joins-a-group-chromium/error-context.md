...
- Name: peerconnect.spec.ts >> PeerConnect >> shows groups, filters them, and joins a group
- Location: tests\e2e\peerconnect.spec.ts:147:7
...
Locator: getByText('CS2040 Midterm Sprint')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('CS2040 Midterm Sprint')
    ...
    - generic [ref=e100]:
      - generic [ref=e102]:
        ...
        - generic [ref=e113]:
          ...
          - button "Create New Group" [ref=e120]:
            - img [ref=e121]
...
```ts
  52  |         invited_by_name: "Jane Doe",
  53  |         status: "pending",
  54  |         email_sent: true,
  55  |         created_at: "2026-04-24T10:00:00.000Z",
  56  |       },
  57  |     ];
  58  | 
  59  |     await page.route("**/api/groups/", async (route) => {
  60  |       const method = route.request().method();
  61  | 
  62  |       if (method === "GET") {
  63  |         await route.fulfill({
  64  |           status: 200,
  65  |           contentType: "application/json",
  66  |           body: JSON.stringify(groups),
  67  |         });
  68  |         return;
  69  |       }
  70  | 
