...
class StudyMaterial(Document):
    ...
    file_type: str = Field(default="", description="Normalized file type label such as PDF, DOCX, or PPTX")
    content_type: str = Field(default="", description="Uploaded file MIME type")
    file_size_bytes: int = Field(default=0, ge=0, description="Original file size in bytes")
    file_path: Optional[str] = Field(default=None, description="Absolute path to the stored uploaded file")
    group_id: Optional[str] = Field(default=None, description="Study group ID when this file is shared in a group")
    uploaded_by_name: Optional[str] = Field(default=None, description="Display name of the uploader")
